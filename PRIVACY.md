# StructRule 개인정보 처리방침

시행일: 2026년 7월 25일

StructRule은 사용자의 개인정보 보호를 중요하게 생각합니다. 이 문서는 StructRule이 어떤 정보에 접근하고 어떻게 처리하는지 설명합니다.

## 수집하는 개인정보

StructRule은 이름, 이메일 주소, 연락처, 위치 정보 등의 개인정보를 수집하지 않습니다. 계정 가입을 요구하지 않으며 광고, 분석 도구 또는 사용자 추적 기능을 사용하지 않습니다.
...
StructRule은 사용자 정보와 파일 내용을 판매하거나 제3자에게 제공하지 않습니다. 앱에는 개인정보나 사용 데이터를 외부로 전송하는 자체 서버 기능이 없습니다.
...
앱 기능이나 법적 요구사항이 변경되면 이 문서가 갱신될 수 있습니다. 변경 내용과 시행일은 이 페이지에 게시합니다.
